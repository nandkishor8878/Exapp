...
import nandkishor.Exapp.utils.MarshMellowPermissions;
...
public class ProfileFragment extends BaseFragment {
    ...
    private LiveMoviesServices liveMoviesServices;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mSocket.connect();
        liveMoviesServices = LiveMoviesServices.getInstance();
...
//        mAllFriendRequestsListener = liveMoviesServices.getFriendRequestBottom(mBottomBar,R.id.tab_friends);
...
//        mUsersNewMessagesListener = liveMoviesServices.getAllNewMessages(mBottomBar,R.id.tab_messages);
...
//        mUsersNewMessagesReference.addValueEventListener(mUsersNewMessagesListener);
    ...
    private static File getOutputFile(){
        File mesdiaStorageDir = new File(Environment.getExternalStoragePublicDirectory(
                Environment.DIRECTORY_PICTURES),"ExApp");
