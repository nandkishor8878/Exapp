...
import nandkishor.Exapp.activites.LoginActivity;
import nandkishor.Exapp.utils.Constants;
import io.socket.client.Socket;
import nandkishor.Exapp.utils.DialogsUtils;
...
public class LiveAccountServices {
    ...
    public Subscription sendRegistrationInfo(final EditText userNameEt, final EditText userEmailEt, final EditText userPasswordEt, final Socket socket){
        List<String> userDetails = new ArrayList<>();
...
//                        else if (integer.equals(SERVER_SUCCESS)){
//
...
//                            }
                            ...
                            Toast.makeText(activity,"Registration Successful! Please Login to Proceed ",Toast.LENGTH_SHORT).show();
                        } else{
